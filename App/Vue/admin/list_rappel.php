...
<h2 id="listUser" style="margin-left:300px;">Liste de rappel</h2><br>
...
<div class="modal fade bd-example-modal-lg<?= $emp['emp']?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          ...
          <h3 style="text-align:center;">Liste de rappel</h3>
    ...
    <input type="hidden" name="idEmp" value="<?= $emp['emp']?>">
      <label for="inputNcard" style="font-weight: bold" >N°carte utlisateur</label>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input style="color:red; font-weight: bold;" type="date" name="Retour_Date" class="form-control" id="inputRD" value="<?= $emp['Retour_Date']?>" readonly>
    </div>
  </div><hr>
  <div class="form-row">
    <div class="form-group col-md-6">
