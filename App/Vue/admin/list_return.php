...
<h2 id="listUser" style="margin-left:300px;">Liste de retours</h2><br>
...
<table  class="table table-hover" style="text-align: center;">
  ...
  <tbody  id="list_table">
    ...
    <tr>
      ...
      <th >
            <button type="button" class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg<?= $emp['emp']?>"><i class="fas fa-eye"></i></button>
...
<div class="modal fade bd-example-modal-lg<?= $emp['emp']?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          ...
          <h3 style="text-align:center;">Détail d'utilisateur</h3>
    ...
    <input type="hidden" name="idEmp" value="<?= $emp['emp']?>">
      ...
      <input type="text" name="ncard" class="form-control" id="inputNcard" value="<?= $emp['ncard']?>"readonly>
    </div>
    
    <div class="form-group col-md-3">
      <label for="inputBookid" style="font-weight: bold">Code de livre</label>
      <input type="text" name="idBook" class="form-control" id="inputBookid" value="<?= $emp['idBook']?>"readonly>
    </div>
    <div class="form-group col-md-3">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="date" name="Emp_Date" class="form-control" id="inputED" value="<?= $emp['Emp_Date']?>"readonly>
    </div>
    <div class="form-group col-md-6">
      <label for="inputRD" style="font-weight: bold">Date de retour</label>
      <input type="date" name="Retour_Date" class="form-control" id="inputRD" value="<?= $emp['Retour_Date']?>"readonly>
    </div>
  </div><hr>
  <div class="form-row">
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="number" name="amende" class="form-control" id="amende" value="<?php if(!empty($emp['amende'])){echo $emp['amende'];}else{echo 0;} ?>"readonly>
    </div>
    <div class="form-group col-md-1">
        <label ></label>
